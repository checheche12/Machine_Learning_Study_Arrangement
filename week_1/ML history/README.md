...
현재는 Suno, Sora, ChatGPT, Midjourney 등
이미지, 영상, 음악을 모두 생성할 수 있는 AI가 상용화되었습니다.
이제 사람들은 더 이상 AI의 가능성을 무시하지 않습니다.

하지만 반대로, AI를 과대평가하거나 두려워할 필요도 없습니다.
AI는 인간을 대체하는 기술이 아니라, 인간이 더 많은 일을 할 수 있게 해주는 도구입니다.

이 강의가 여러분이 AI를 이해하고, 그것을 활용할 수 있는 초석이 되기를 바랍니다.
세상에는 여전히 AI로 해결할 수 있는 기회들이 무수히 떨어져 있습니다.
그걸 줍는 사람은 기술을 이해한 사람일 것입니다.
